...
struct VercelGatewayControls: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            .help(String(localized: "settings.vercel.help", defaultValue: "Route Claude requests through Vercel AI Gateway for safer access to your Claude Max subscription", comment: "Help text explaining Vercel AI Gateway benefit"))
...
struct ServiceRow<ExtraContent: View>: View {
    ...
    var body: some View {
        ...
        .alert(String(localized: "settings.remove-account.title", defaultValue: "Remove Account", comment: "Alert title when removing an account"), isPresented: $showingRemoveConfirmation) {
            Button(String(localized: "common.cancel", defaultValue: "Cancel", comment: "Cancel button label"), role: .cancel) {
                accountToRemove = nil
            }
...
struct SettingsView: View {
    ...
    var body: some View {
            ...
            Form {
                ...
                Section {
                    ...
                    HStack {
                        ...
                        Spacer()
                        Button(String(localized: "settings.open-folder", defaultValue: "Open Folder", comment: "Button to open authentication files folder")) {
                            openAuthFolder()
                        }
                    }
                }
                ...
                Section(String(localized: "settings.services", defaultValue: "Services", comment: "Section header for AI services")) {
                    ...
                    ServiceRow(
                        ...
                        customTitle: serverManager.vercelGatewayEnabled && !serverManager.vercelApiKey.isEmpty ? String(localized: "settings.claude.via-vercel", defaultValue: "Claude Code (via Vercel)", comment: "Custom title when Claude is routed via Vercel Gateway") : nil,
                    ...
                    ServiceRow(
                        ...
                        helpText: String(localized: "settings.gemini.help", defaultValue: "⚠️ Note: If you're an existing Gemini user with multiple projects, authentication will use your default project. Set your desired project as default in Google AI Studio before connecting.", comment: "Help text warning about Gemini project selection"),
        ...
        .sheet(isPresented: $showingQwenEmailPrompt) {
            VStack(spacing: 16) {
                Text(String(localized: "settings.qwen-email.title", defaultValue: "Qwen Account Email", comment: "Title for Qwen email prompt dialog"))
                    .font(.headline)
                Text(String(localized: "settings.qwen-email.prompt", defaultValue: "Enter your Qwen account email address", comment: "Prompt for user to enter Qwen email"))
                    .font(.caption)
                    .foregroundColor(.secondary)
                TextField(String(localized: "settings.qwen-email.placeholder", defaultValue: "your.email@example.com", comment: "Placeholder for Qwen email field"), text: $qwenEmail)
                    ...
                    .frame(width: 250)
                HStack(spacing: 12) {
                    Button(String(localized: "common.cancel", defaultValue: "Cancel", comment: "Cancel button label")) {
                        showingQwenEmailPrompt = false
                        qwenEmail = ""
                    }
                    Button(String(localized: "settings.qwen-email.continue", defaultValue: "Continue", comment: "Button to continue with Qwen authentication")) {
                        showingQwenEmailPrompt = false
        ...
        .sheet(isPresented: $showingZaiApiKeyPrompt) {
            VStack(spacing: 16) {
                Text(String(localized: "settings.zai-key.title", defaultValue: "Z.AI API Key", comment: "Title for Z.AI API key prompt dialog"))
                    .font(.headline)
                Text(String(localized: "settings.zai-key.prompt", defaultValue: "Enter your Z.AI API key from https://z.ai/manage-apikey/apikey-list", comment: "Prompt for user to enter Z.AI API key"))
                    .font(.caption)
                    .foregroundColor(.secondary)
                ...
                HStack(spacing: 12) {
                    ...
                    Button(String(localized: "settings.zai-key.add", defaultValue: "Add Key", comment: "Button to add Z.AI API key")) {
                        showingZaiApiKeyPrompt = false
        ...
        .alert(String(localized: "settings.auth-result.title", defaultValue: "Authentication Result", comment: "Alert title for authentication result"), isPresented: $showingAuthResult) {
            Button(String(localized: "common.ok", defaultValue: "OK", comment: "OK button label"), role: .cancel) { }
        } message: {
        ...
        serverManager.runAuthCommand(command) { success, output in
            ...
            DispatchQueue.main.async {
                ...
                if success {
                    ...
                    let details = output.isEmpty ? String(localized: "settings.auth-result.no-output", defaultValue: "No output from authentication process", comment: "Message when auth process produces no output") : output
