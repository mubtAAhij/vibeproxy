...
class ServerManager: ObservableObject {
    ...
    func saveZaiApiKey(_ apiKey: String, completion: @escaping (Bool, String) -> Void) {
        ...
        do {
            ...
            completion(false, String(format: String(localized: "server.error.save-api-key-failed", defaultValue: "Failed to save API key: %@", bundle: .main, comment: "Error when API key save fails"), error.localizedDescription))
        }
    }
