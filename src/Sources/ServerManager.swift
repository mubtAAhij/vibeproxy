...
class ServerManager: ObservableObject {
    ...
    func saveZaiApiKey(_ apiKey: String, completion: @escaping (Bool, String) -> Void) {
        ...
        do {
            ...
            completion(true, String(localized: "zai.api-key-saved", defaultValue: "API key saved successfully", comment: "Success message when Z.AI API key is saved"))
        } catch {
            completion(false, String(format: String(localized: "zai.error.failed-to-save-key", defaultValue: "Failed to save API key: %@", comment: "Error when Z.AI API key cannot be saved"), error.localizedDescription))
        }
    }
