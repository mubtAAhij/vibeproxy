                ...
                throw ZAIAPIKeyStoreError.failedToCreateDirectory(
                    String(
                        format: String(
                            ...
                            bundle: .main,
                            comment: "Error message when creating the Z.AI auth directory fails"
                        ),
                        directoryURL.path,
                ...
                throw ZAIAPIKeyStoreError.failedToSerializeKey(
                    String(
                        format: String(
                            ...
                            bundle: .main,
                            comment: "Error message when serializing Z.AI API key JSON fails"
                        ),
                        error.localizedDescription
                    )
                )
                ...
                throw ZAIAPIKeyStoreError.failedToWriteKey(
                    String(
                        format: String(
                            ...
                            bundle: .main,
                            comment: "Error message when writing Z.AI API key file fails"
                        ),
                        filePath.path,
                        error.localizedDescription
                    )
                        ...
                        ZAIAPIKeyLoadIssue(
                            ...
                            message: String(
                                format: String(
                                    ...
                                    bundle: .main,
                                    comment: "Error message for unexpected failure while loading API key file"
                                ),
                                file.path,
                                error.localizedDescription
                            )
    ...
    private func loadActiveAPIKey(at filePath: URL) throws -> String? {
            ...
            throw ZAIAPIKeyStoreError.failedToReadKey(
                String(
                    format: String(
                        ...
                        bundle: .main,
                        comment: "Error message when reading Z.AI API key file fails"
                    ),
                    filePath.path,
                    error.localizedDescription
                )
        ...
        do {
            ...
            throw ZAIAPIKeyStoreError.invalidKeyJSON(
                String(
                    format: String(
                        localized: "zai-api-key-store.error.invalid-json",
                        defaultValue: "Z.AI API key file at %@ contains invalid JSON: %@",
                        bundle: .main,
                        comment: "Error message when Z.AI API key file contains invalid JSON"
                    ),
                    filePath.path,
                    error.localizedDescription
                )
        ...
        guard let json = ConfigComposer.stringKeyedDictionary(jsonObject) else {
            throw ZAIAPIKeyStoreError.malformedKey(
                String(
                    format: String(
                        localized: "zai-api-key-store.error.malformed-key.not-json-object",
                        defaultValue: "Z.AI API key file at %@ must contain a JSON object.",
                        bundle: .main,
                        comment: "Error message when Z.AI API key file JSON root is not an object"
                    ),
                    filePath.path
                )
            )
        ...
        guard (json["type"] as? String) == Self.authType else {
            throw ZAIAPIKeyStoreError.malformedKey(
                String(
                    format: String(
                        localized: "zai-api-key-store.error.malformed-key.unexpected-type",
                        defaultValue: "Z.AI API key file at %@ has an unexpected type.",
                        bundle: .main,
                        comment: "Error message when Z.AI API key file type field does not match expected value"
                    ),
                    filePath.path
                )
            )
        ...
        guard let apiKey = json["api_key"] as? String, !apiKey.isEmpty else {
            throw ZAIAPIKeyStoreError.malformedKey(
                String(
                    format: String(
                        localized: "zai-api-key-store.error.malformed-key.missing-api-key",
                        defaultValue: "Z.AI API key file at %@ is missing an api_key.",
                        bundle: .main,
                        comment: "Error message when Z.AI API key file is missing api_key field"
                    ),
                    filePath.path
                )
            )
