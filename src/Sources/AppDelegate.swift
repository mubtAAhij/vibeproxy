...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    func setupMenuBar() {
        ...
        // Server Status
        menu.addItem(NSMenuItem(title: String(localized: "menubar.status.stopped", defaultValue: "Server: Stopped", comment: "Server stopped status in menu bar"), action: nil, keyEquivalent: ""))
    ...
    @objc func updateMenuBarStatus() {
        ...
        if let serverStatus = menu.item(at: 0) {
            serverStatus.title = serverManager.isRunning ? String(format: String(localized: "menubar.status.running", defaultValue: "Server: Running (port %d)", comment: "Server running status with port number"), thinkingProxy.proxyPort) : String(localized: "menubar.status.stopped", defaultValue: "Server: Stopped", comment: "Server stopped status in menu bar")
        }
