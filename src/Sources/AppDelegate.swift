...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    @objc func copyServerURL() {
        ...
        showNotification(title: String(localized: "notification.copied.title", defaultValue: "Copied", comment: "Notification title when content is copied"), body: String(localized: "notification.copied.server-url", defaultValue: "Server URL copied to clipboard", comment: "Notification body when server URL is copied"))
    }
