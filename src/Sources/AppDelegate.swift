...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setupMainMenu() {
        ...
        appMenu.addItem(NSMenuItem(title: String(
            ...
            comment: "Application menu item title to quit app with app name"
        ...
        editMenu.addItem(NSMenuItem(title: String(
            ...
            defaultValue: "Undo",
            comment: "Edit menu item title for Undo action"
        ), action: Selector(("undo:")), keyEquivalent: "z"))
        editMenu.addItem(NSMenuItem(title: String(
            localized: "app.menu.edit.redo",
            defaultValue: "Redo",
            comment: "Edit menu item title for Redo action"
        ), action: Selector(("redo:")), keyEquivalent: "Z"))
        editMenu.addItem(NSMenuItem.separator())
        editMenu.addItem(NSMenuItem(title: String(
            localized: "app.menu.edit.cut",
            defaultValue: "Cut",
            comment: "Edit menu item title for Cut action"
        ), action: #selector(NSText.cut(_:)), keyEquivalent: "x"))
        editMenu.addItem(NSMenuItem(title: String(
            localized: "app.menu.edit.copy",
            defaultValue: "Copy",
            comment: "Edit menu item title for Copy action"
        ), action: #selector(NSText.copy(_:)), keyEquivalent: "c"))
        editMenu.addItem(NSMenuItem(title: String(
            localized: "app.menu.edit.paste",
            defaultValue: "Paste",
            comment: "Edit menu item title for Paste action"
        ), action: #selector(NSText.paste(_:)), keyEquivalent: "v"))
        editMenu.addItem(NSMenuItem(title: String(
            localized: "app.menu.edit.select-all",
            defaultValue: "Select All",
            comment: "Edit menu item title for Select All action"
    ...
    func setupMenuBar() {
        ...
        menu.addItem(NSMenuItem(title: String(
            localized: "app.status-item.server-stopped",
            defaultValue: "Server: Stopped",
            comment: "Status item title when server is stopped"
        ), action: nil, keyEquivalent: ""))
        menu.addItem(NSMenuItem.separator())

        // Main Actions
        menu.addItem(NSMenuItem(title: String(
            localized: "app.status-item.open-settings",
        ...
        let startStopItem = NSMenuItem(title: String(
            localized: "app.status-item.start-server",
        ...
        let copyURLItem = NSMenuItem(title: String(
            localized: "app.status-item.copy-server-url",
            defaultValue: "Copy Server URL",
            comment: "Status menu item title to copy server URL to clipboard"
        ...
        let dashboardItem = NSMenuItem(title: String(
            localized: "app.status-item.open-dashboard",
        ...
        let checkForUpdatesItem = NSMenuItem(title: String(
            localized: "app.status-item.check-for-updates",
        ...
        // Quit
        menu.addItem(NSMenuItem(title: String(
            localized: "app.status-item.quit",
            defaultValue: "Quit",
                ...
                DispatchQueue.main.async {
                    if success {
                        ...
                        self?.showNotification(title: String(
                            ...
                            comment: "Notification body shown when server starts successfully"
                        ))
                    } else {
                        ...
                        self?.showNotification(title: String(
                            ...
                            comment: "Notification body shown when backend server fails to start on default port"
                        ))
                    }
                }
            }
        ...
        if attempts >= maxAttempts {
            DispatchQueue.main.async { [weak self] in
                ...
                self?.showNotification(title: String(
                    ...
                    localized: "app.notification.server-failed-thinking-proxy-timeout.body",
                    defaultValue: "Could not start thinking proxy on port 8317 (timeout)",
                    comment: "Notification body shown when thinking proxy startup times out"
                ))
            }
            return
        }
    ...
    @objc func copyServerURL() {
        ...
        showNotification(title: String(
            localized: "app.notification.copied.title",
            defaultValue: "Copied",
            comment: "Notification title shown after copying server URL"
        ), body: String(
            localized: "app.notification.server-url-copied.body",
            defaultValue: "Server URL copied to clipboard",
            comment: "Notification body shown after copying server URL to clipboard"
        ))
    }
    ...
    @objc func updateMenuBarStatus() {
        ...
        if let serverStatus = menu.item(at: 0) {
            serverStatus.title = serverManager.isRunning ? String(format: String(
                localized: "app.status-item.server-running-port",
                defaultValue: "Server: Running (port %d)",
                comment: "Status item title when server is running with active port"
        ...
        if let startStopItem = menu.item(withTag: 100) {
            startStopItem.title = serverManager.isRunning ? String(
                localized: "app.status-item.stop-server",
