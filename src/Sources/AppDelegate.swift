...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setupMainMenu() {
        ...
        let editMenu = NSMenu(title: String(localized: "menu.edit", defaultValue: "Edit", comment: "Edit menu"))
    ...
    func setupMenuBar() {
        ...
        // Copy URL
        let copyURLItem = NSMenuItem(title: String(localized: "menubar.copy-server-url", defaultValue: "Copy Server URL", comment: "Copy Server URL menu item"), action: #selector(copyServerURL), keyEquivalent: "c")
        ...
        // Check for Updates
        let checkForUpdatesItem = NSMenuItem(title: String(localized: "menubar.check-for-updates", defaultValue: "Check for Updates...", comment: "Check for Updates menu item"), action: #selector(SPUStandardUpdaterController.checkForUpdates(_:)), keyEquivalent: "u")
