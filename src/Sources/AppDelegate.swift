...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    func setupMenuBar() {
        ...
        // Server Status
        menu.addItem(NSMenuItem(title: String(localized: "menu.server-stopped", defaultValue: "Server: Stopped", comment: "Menu item showing server is stopped"), action: nil, keyEquivalent: ""))
        ...
        // Copy URL
        let copyURLItem = NSMenuItem(title: String(localized: "menu.copy-url", defaultValue: "Copy Server URL", comment: "Menu item to copy server URL to clipboard"), action: #selector(copyServerURL), keyEquivalent: "c")
        ...
        // Quit
        menu.addItem(NSMenuItem(title: String(localized: "menu.quit", defaultValue: "Quit", comment: "Menu item to quit application"), action: #selector(quit), keyEquivalent: "q"))
    ...
    @objc func updateMenuBarStatus() {
        ...
        if let serverStatus = menu.item(at: 0) {
            serverStatus.title = serverManager.isRunning ? String(format: NSLocalizedString("menu.server-running", comment: "Menu item showing server is running with port"), thinkingProxy.proxyPort) : String(localized: "menu.server-stopped", defaultValue: "Server: Stopped", comment: "Menu item showing server is stopped")
        }
