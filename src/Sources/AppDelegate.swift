...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setupMainMenu() {
        ...
        let appMenu = NSMenu()
        appMenu.addItem(NSMenuItem(title: String(localized: "menu.about", defaultValue: "About VibeProxy", comment: "About menu item in app menu"), action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: ""))
    ...
    func setupMenuBar() {
        ...
        // Main Actions
        menu.addItem(NSMenuItem(title: String(localized: "menubar.open-settings", defaultValue: "Open Settings", comment: "Menu item to open settings window"), action: #selector(openSettings), keyEquivalent: "s"))
        menu.addItem(NSMenuItem.separator())
        ...
        // Copy URL
        let copyURLItem = NSMenuItem(title: String(localized: "menubar.copy-url", defaultValue: "Copy Server URL", comment: "Menu item to copy server URL to clipboard"), action: #selector(copyServerURL), keyEquivalent: "c")
        ...
        // Check for Updates
        let checkForUpdatesItem = NSMenuItem(title: String(localized: "menubar.check-updates", defaultValue: "Check for Updates...", comment: "Menu item to check for app updates"), action: #selector(SPUStandardUpdaterController.checkForUpdates(_:)), keyEquivalent: "u")
        ...
        // Quit
        menu.addItem(NSMenuItem(title: String(localized: "menubar.quit", defaultValue: "Quit", comment: "Menu item to quit application"), action: #selector(quit), keyEquivalent: "q"))
    ...
    @objc func updateMenuBarStatus() {
        ...
        if let button = statusItem.button {
            ...
            if let icon = IconCatalog.shared.image(named: iconName, resizedTo: NSSize(width: 18, height: 18), template: true) {
                ...
                let runningDesc = String(localized: "menubar.icon.running", defaultValue: "Running", comment: "Accessibility description for running server icon")
                let stoppedDesc = String(localized: "menubar.icon.stopped", defaultValue: "Stopped", comment: "Accessibility description for stopped server icon")
