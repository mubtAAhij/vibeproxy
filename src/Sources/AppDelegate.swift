...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, UNUserNotificationCenterDelegate {
    ...
    func setupMenuBar() {
        ...
        // Copy URL
        let copyURLItem = NSMenuItem(title: String(localized: "menu.copy-server-url", defaultValue: "Copy Server URL", comment: "Menu item to copy server URL"), action: #selector(copyServerURL), keyEquivalent: "c")
