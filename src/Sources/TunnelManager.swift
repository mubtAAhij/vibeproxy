...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared-not-installed.title", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not installed on the system")
        alert.informativeText = String(localized: "tunnel.cloudflared-not-installed.message", defaultValue: """
        ...
        """, comment: "Instructions for installing cloudflared via Homebrew or from GitHub releases")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-button", defaultValue: "Copy Install Command", comment: "Button to copy the brew install command to clipboard"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel-button", defaultValue: "Cancel", comment: "Button to dismiss the cloudflared installation instructions alert"))
