...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy installation command"))
