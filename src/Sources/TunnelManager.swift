...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, bundle: .main, comment: "Alert message with installation instructions for cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-install.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy brew install command"))
        alert.addButton(withTitle: String(localized: "common.cancel", defaultValue: "Cancel", bundle: .main, comment: "Cancel button"))
