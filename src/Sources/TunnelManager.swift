...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.addButton(withTitle: String(localized: "tunnel-manager.copy-install-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy the install command to clipboard"))
