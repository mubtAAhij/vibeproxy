...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.informativeText = String(localized: "tunnel.cloudflared-not-installed.message", defaultValue: "To expose your server to the internet, you need to install cloudflared.\n\nInstall via Homebrew:\nbrew install cloudflared\n\nOr download from:\nhttps://github.com/cloudflare/cloudflared/releases", bundle: .main, comment: "Instructions for installing cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.copy-install-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy cloudflared install command"))
        alert.addButton(withTitle: String(localized: "tunnel.cancel", defaultValue: "Cancel", bundle: .main, comment: "Cancel button"))
