...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, bundle: .main, comment: "Instructions for installing cloudflared via Homebrew or direct download")
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel", defaultValue: "Cancel", bundle: .main, comment: "Cancel button for cloudflared install dialog"))
