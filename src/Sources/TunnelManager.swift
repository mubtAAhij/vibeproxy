...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared-not-installed.title", defaultValue: "Cloudflared Not Installed", bundle: .main, comment: "Alert title when cloudflared binary is missing")
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy Homebrew install command"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel", defaultValue: "Cancel", bundle: .main, comment: "Button to dismiss cloudflared alert"))
