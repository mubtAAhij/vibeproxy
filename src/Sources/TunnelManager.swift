...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, comment: "Alert message with instructions to install cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy install command to clipboard"))
