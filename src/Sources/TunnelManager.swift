...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel-manager.cloudflared-install.message-title", defaultValue: "Cloudflared Not Installed", bundle: .main, comment: "Alert title shown when cloudflared is not installed")
        alert.informativeText = String(localized: "tunnel-manager.cloudflared-install.instructions", defaultValue: "To expose your server to the internet, you need to install cloudflared.\n\nInstall via Homebrew:\nbrew install cloudflared\n\nOr download from:\nhttps://github.com/cloudflare/cloudflared/releases", bundle: .main, comment: "Alert instructions for installing cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel-manager.cloudflared-install.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button title that copies cloudflared install command"))
