...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, comment: "Alert message with cloudflared installation instructions")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy installation command to clipboard"))
