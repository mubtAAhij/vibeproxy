...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy brew install command"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared.cancel", defaultValue: "Cancel", comment: "Cancel button in cloudflared alert"))
