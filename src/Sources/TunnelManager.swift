...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel-manager.cloudflared-not-installed.title", defaultValue: "Cloudflared Not Installed", comment: "Title for alert when cloudflared is not installed")
        ...
        alert.addButton(withTitle: String(localized: "tunnel-manager.copy-install-command", defaultValue: "Copy Install Command", comment: "Button to copy the install command to clipboard"))
