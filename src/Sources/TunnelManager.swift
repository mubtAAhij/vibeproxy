...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.messageText = String(
            localized: "tunnel-manager.cloudflared-install.message-title",
        ...
        alert.informativeText = String(
            ...
            bundle: .main,
            comment: "Alert instructions for installing cloudflared"
        )
        ...
        alert.addButton(withTitle: String(
            ...
            bundle: .main,
            comment: "Button title that copies cloudflared install command"
        ))
        alert.addButton(withTitle: String(
