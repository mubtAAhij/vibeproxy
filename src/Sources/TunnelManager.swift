...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared-missing.title", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not installed")
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-missing.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy Homebrew install command"))
