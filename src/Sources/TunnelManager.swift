...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.informativeText = String(localized: "tunnel.cloudflared.install-instructions", defaultValue: """
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy installation command to clipboard"))
