...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-install.copy-button", defaultValue: "Copy Install Command", comment: "Button to copy install command to clipboard"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-install.cancel-button", defaultValue: "Cancel", comment: "Button to dismiss install instructions"))
