...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        alert.informativeText = String(localized: "tunnel.cloudflared.not-installed.message", defaultValue: "To expose your server to the internet, you need to install cloudflared.\n\nInstall via Homebrew:\nbrew install cloudflared\n\nOr download from:\nhttps://github.com/cloudflare/cloudflared/releases", comment: "Instructions for installing cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy the cloudflared install command"))
        alert.addButton(withTitle: String(localized: "general.cancel", defaultValue: "Cancel", comment: "Cancel button"))
