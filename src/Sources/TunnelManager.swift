...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared-not-installed", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not installed")
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cancel", defaultValue: "Cancel", comment: "Button to dismiss cloudflared install dialog"))
