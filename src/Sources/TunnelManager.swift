...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel-manager.cloudflared.install-required.title", defaultValue: "Cloudflared Not Installed", bundle: .main, comment: "Alert title when cloudflared is missing")
        alert.informativeText = String(localized: "tunnel-manager.cloudflared.install-required.message", defaultValue: "To expose your server to the internet, you need to install cloudflared.\n\nInstall via Homebrew:\nbrew install cloudflared\n\nOr download from:\nhttps://github.com/cloudflare/cloudflared/releases", bundle: .main, comment: "Alert body with cloudflared installation instructions")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel-manager.cloudflared.install-required.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Primary button title to copy cloudflared install command"))
        alert.addButton(withTitle: String(localized: "common.button.cancel", defaultValue: "Cancel", bundle: .main, comment: "Cancel button title"))
