...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared-not-installed.title", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared binary is not found")
        ...
        """, comment: "Instructions for installing cloudflared via Homebrew or direct download")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy Homebrew install command to clipboard"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel", defaultValue: "Cancel", comment: "Button to dismiss cloudflared install alert"))
