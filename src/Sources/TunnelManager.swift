...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared.title", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not installed")
        alert.informativeText = String(localized: "tunnel.cloudflared.instructions", defaultValue: """
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared.cancel", defaultValue: "Cancel", comment: "Cancel button"))
