...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, bundle: .main, comment: "Alert message with cloudflared installation instructions")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy the cloudflared install command"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel", defaultValue: "Cancel", bundle: .main, comment: "Button to dismiss the cloudflared installation alert"))
