...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel-manager.cloudflared-not-installed.title", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not installed")
        ...
        alert.addButton(withTitle: String(localized: "tunnel-manager.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy brew install command to clipboard"))
        alert.addButton(withTitle: String(localized: "tunnel-manager.cloudflared-not-installed.cancel", defaultValue: "Cancel", comment: "Button to dismiss cloudflared installation alert"))
