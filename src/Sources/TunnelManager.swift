...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel-manager.cloudflared-not-installed", defaultValue: "Cloudflared Not Installed", bundle: .main, comment: "Alert title when cloudflared is not found")
        ...
        alert.addButton(withTitle: String(localized: "tunnel-manager.copy-install-command", defaultValue: "Copy Install Command", bundle: .main, comment: "Button to copy cloudflared install command"))
        alert.addButton(withTitle: String(localized: "tunnel-manager.cancel", defaultValue: "Cancel", bundle: .main, comment: "Cancel button"))
