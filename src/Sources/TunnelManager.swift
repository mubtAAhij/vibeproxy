...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.error.cloudflared-not-installed", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not installed")
        alert.informativeText = String(localized: "tunnel.error.cloudflared-instructions", defaultValue: """
        ...
        alert.addButton(withTitle: String(localized: "tunnel.action.copy-install-command", defaultValue: "Copy Install Command", comment: "Button to copy brew install command"))
