...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, comment: "Installation instructions for cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy install command"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel", defaultValue: "Cancel", comment: "Cancel button for cloudflared install alert"))
