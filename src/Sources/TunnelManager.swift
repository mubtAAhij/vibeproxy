...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        ...
        """, comment: "Alert message with installation instructions for cloudflared")
        alert.alertStyle = .informational
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-command", defaultValue: "Copy Install Command", comment: "Button to copy installation command to clipboard"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel", defaultValue: "Cancel", comment: "Button to dismiss cloudflared installation alert"))
