...
class TunnelManager {
    ...
    private func showCloudflaredInstallInstructions() {
        let alert = NSAlert()
        alert.messageText = String(localized: "tunnel.cloudflared-not-installed.title", defaultValue: "Cloudflared Not Installed", comment: "Alert title when cloudflared is not found")
        ...
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.copy-button", defaultValue: "Copy Install Command", comment: "Button to copy brew install command to clipboard"))
        alert.addButton(withTitle: String(localized: "tunnel.cloudflared-not-installed.cancel-button", defaultValue: "Cancel", comment: "Button to dismiss cloudflared install alert"))
